...
$lang = array_merge($lang, array(
    ...
    'LINK_ADD_ERROR'            => '!! UNEXPECTED ERROR IN THE MANAGEMENT OF Store To Mega !!<br>Report this error to the forum moderators.',
    ...
    'BAD_ACCOUNT_MEGA'          => 'MEGA Account ERROR: The MEGA account set up by the administration IS CORRUPT.<br>Please report this error to the forum moderators so they can reassign a new MEGA account.',

    // INSTALL
    'MEGATOOLS_ERROR'           => 'Store To Mega cannot be installed.<br><br>- Required the <b>Megatools v1.11</b> tool installed and enabled on the Server.',
